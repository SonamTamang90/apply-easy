      ...
      <Container>
        <div className="text-center mb-16">
          ...
          <p className="text-base text-gray-700 max-w-lg mx-auto">
            Start free and upgrade as your career goals evolve. No hidden fees, cancel anytime.
          </p>
        </div>
                  ...
                  <div className="mt-8">
                    ...
                    <ul className="mt-3 space-y-3">
                      {plan.features.map((feature, featureIdx) => (
                        <li key={featureIdx} className="flex items-start gap-4 text-sm/6 text-gray-600">
                          <span className="inline-flex h-6 items-center">
                            <svg className="size-4 fill-gray-400" viewBox="0 0 20 20" fill="currentColor">
                              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.236 4.53L8.465 10.5a.75.75 0 00-1.06 1.061l1.732 1.732a.75.75 0 001.154-.114l3.857-5.398z" clipRule="evenodd" />
                            </svg>
                          </span>
                          {feature}
                        </li>
